    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(order == Session["order_no"].ToString())
        {
            ...
            foreach(DataRow dr in dt.Rows)
            {
                ...
                cmd1.CommandText = "insert into orders values('"+dr["firstname"].ToString()+"','"+ dr["lastname"].ToString() + "','"+ dr["email"].ToString() + "','"+ dr["adress"].ToString() + "','"+ dr["city"].ToString() + "','"+ dr["state"].ToString() + "','"+ dr["pincode"].ToString() + "','"+ dr["mobile"].ToString() + "')";
            ...
            if (Request.Cookies["aa"] != null)
            {
                ...
                for (int i = 0; i < strArr.Length; i++)
                {
                    ...
                    cmd3.CommandText = "insert into order_detail values('"+order_id.ToString()+"','"+a[0].ToString()+"','"+a[2].ToString()+"','"+a[3].ToString()+"','"+a[4].ToString()+"')";
