...
public partial class user_product_desc : System.Web.UI.Page
{
    ...
    protected void b1_Click(object sender, EventArgs e)
    {
        ...
        {
            l1.Text = "";
            int quantity = Convert.ToInt32(t1.Text.ToString());
            if (Request.Cookies["aa"] == null)
            {
                Response.Cookies["aa"].Value = product_name.ToString() + "," + product_desc.ToString() + "," + product_price.ToString() + "," + quantity.ToString() + "," + product_image.ToString() + "," + id.ToString();
                Response.Cookies["aa"].Expires = DateTime.Now.AddDays(1);
            }
            else
            {
                Response.Cookies["aa"].Value = Request.Cookies["aa"].Value + "|" + product_name.ToString() + "," + product_desc.ToString() + "," + product_price.ToString() + "," + quantity.ToString() + "," + product_image.ToString() + "," + id.ToString();
                Response.Cookies["aa"].Expires = DateTime.Now.AddDays(1);
            }
